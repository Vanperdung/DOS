...
second_stage:
    ...
    ; Set offset
    mov word[ss:0x00], isr_0 ; Set the value of address 0x0000:0x00 to the address of isr_0
    ; Set segment
    mov word[ss:0x02], ds ; Set the value of address 0x0000:0x02 to the data segment
    int 0x00 ; Call interrupt 0x00
    ; Processor will find the ISR address at 0x0000:0x00 and execute the ISR, which is isr_0

    mov word[ss:0x04], isr_1 
    mov word[ss:0x06], ds
    int 0x01
